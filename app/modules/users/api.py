...
from app.core.deps import CurrentSession, CurrentUser, CurrentAdmin
...
@router.get("/", summary="[Admin] Danh sách người dùng", dependencies=[Depends(CurrentAdmin)])
def get_users(db: CurrentSession) -> ResponseModel[List[GetUserDetail]]:
